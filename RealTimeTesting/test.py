...
from filter import bandpass_filter, notch_filter, ica_blink_filter, clean_eeg_ica_threshold
...
def classify(stop_event):
    ...
    csv_path = os.path.join(os.path.dirname(__file__), '../AllData/nickreal2.csv')
